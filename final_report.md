...
\begin{minipage}{0.45\textwidth}
  \includegraphics[width=\linewidth]{./plots/Rplot04.png}
  \centering
  (a)
\end{minipage}
\hspace{0.5cm}
\begin{minipage}{0.45\textwidth}
  \includegraphics[width=\linewidth]{./plots/Rplot06.png}
  \centering
  (b)
\end{minipage}
...
% Second Row
\begin{minipage}{0.45\textwidth}
  \includegraphics[width=\linewidth]{./plots/Rplot07.png}
  \centering
  (c)
\end{minipage}
\hspace{0.5cm}
\begin{minipage}{0.45\textwidth}
  \includegraphics[width=\linewidth]{./plots/Rplot08.png}
  \centering
  (d)
\end{minipage}
...
The bar plots (b) indicate imbalances in categorical variables, such as more subjects of a particular gender, race, and a higher prevalence of non-smokers and those without hypertension or diabetes. The correlation matrix (c) illustrates degrees of association between variables; notably, weight has a positive correlation with BMI, and both are negatively correlated with recovery time.The box plot (d) compares recovery times between groups A and B; both have similar medians, but B's wider range and outliers indicate more variability and longer recoveries for some people.
